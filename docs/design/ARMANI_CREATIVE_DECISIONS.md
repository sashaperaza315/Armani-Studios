...
**Resolved 2026-07-23:** Armani confirmed directly — he wants combat. Decision 8 is now locked canon, same standing as Decisions 1-7. Hollowhunt is now a Discover-and-Escape game *with* a real fight-back option, not evasion-only. This is a real identity shift from the original pitch and should be reflected in GDD section 1 ("What makes it Hollowhunt") the next time that section is revised.

**New open item raised by locking Decision 8:** defeating The Watcher currently just ends Sprint 0's one level with a win screen — there is no "next level" to advance to, because only one location (The Forgotten Orchard) has ever been built. "Advance to next level" is Phase 3 scope (second creature + second location) per `ROADMAP.md`, not something Sprint 0 was ever scheduled to include. Needs a producer/Armani decision on whether to pull Phase 3 forward now that combat gives players something to "win into," or ship a placeholder "more Hollowhunt coming" screen and keep Phase 3 on its original timeline.
